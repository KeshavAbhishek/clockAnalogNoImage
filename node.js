if(window.innerWidth<=700){
    document.getElementById('circularFrame').style.background=`url('https://picsum.photos/${parseInt(window.innerWidth*0.7)}')`;
}
else{
    document.getElementById('circularFrame').style.background=`url('https://picsum.photos/${parseInt(window.innerWidth*0.3)}')`;
}
